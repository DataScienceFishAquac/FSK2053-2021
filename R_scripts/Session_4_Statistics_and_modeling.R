library(tidyverse)
###############################################################################################################
### In this hands-on session we will show some examples of basic hypothesis test for several types of variables
### And we will show how to perform simple linear models in R
###############################################################################################################
...
anova(model_greens_coho_null,model_greens_coho)
...
anova(model_greens_dolly_null,model_greens_dolly)
